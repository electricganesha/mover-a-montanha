...
adminApp.controller('AllPostsCtrl', function($scope, $window, $modal, postList, Posts, authorList, categoryList, Authors, Categories, ngToast, Users){
	...
	{
		$modal.open({
			templateUrl: '/admin/templates/modals/creationDateModal_all.html',
			backdrop: true,
			windowClass: 'creationDateModal',
			scope:$scope,
			controller: function ($rootScope, $scope, $timeout, $modalInstance, $log) {
				...
				$('input.timepicker').timepicker({
					...
					$scope.updateEmailHour = function(creationHour)
					{
						if(creationHour != "" && creationHour.length == 4 && creationHour.indexOf(':') !== -1)
						{
							...
							$scope.activePost.created_at.setMinutes(parseInt(hourSplit[1]));
						}
					}
				}
			});
		...
		$scope.autoPublicationModal = function()
		{
			$modal.open({
				templateUrl: '/admin/templates/modals/autoPublicationModal_all.html',
				backdrop: true,
				windowClass: 'autoPublicationModal',
				scope:$scope,
				controller: function ($rootScope, $scope, $timeout, $modalInstance, $log) {
		...
		adminApp.controller('AddPostCtrl', function($scope, Posts, authorList, Categories, ngToast, $modal){
			$scope.post = {};
			$scope.authors = authorList;
			$scope.selectedAuthor = {};
			...
			{
				$modal.open({
					templateUrl: '/admin/templates/modals/creationDateModal_add.html',
					backdrop: true,
					windowClass: 'creationDateModal',
					scope:$scope,
					controller: function ($rootScope, $scope, $timeout, $modalInstance, $log) {
				...
				{
					$modal.open({
						templateUrl: '/admin/templates/modals/autoPublicationModal_add.html',
						backdrop: true,
						windowClass: 'autoPublicationModal',
						scope:$scope,
						controller: function ($rootScope, $scope, $timeout, $modalInstance, $log) {
